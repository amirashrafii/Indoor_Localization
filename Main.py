...
parser.add_argument('--max_epoch', type=int, default=10, help='Epoch to run [default: 20]')
...
print(BATCH_NUM_QUERIES)
print(EVAL_BATCH_SIZE)
print(NUM_POINTS)
print(MOMENTUM)


TRAIN_FILE = "/home/aa9sz/Driver_in_the_loop/Amir/Indoor Localization/Link Lab Data/Model/6X6/training_queries_baseline.pickle"
TEST_FILE = "/home/aa9sz/Driver_in_the_loop/Amir/Indoor Localization/Link Lab Data/Model/6X6/test_queries_baseline_6-12.pickle"
...
def train_one_epoch(sess, ops, train_writer, test_writer, epoch, saver):
    ...
    for i in range(len(train_file_idxs) // BATCH_NUM_QUERIES):
        ...
        for j in range(BATCH_NUM_QUERIES):
            #print("batch_keys[j]", batch_keys[j])
