...
# BASE_PATH=os.path.join(r"D:\Link Lab Dataset\Bin_Files_Submaps")
#BASE_PATH=os.path.join("S:/")
# BASE_PATH=os.path.join(r"F:\aashr\Documents\New Submaps WithHolo")
BASE_PATH=os.path.join(r"/home/aa9sz/Driver_in_the_loop/Amir/Indoor Localization/Link Lab Data/6X6/")
...
def get_query_tuple(dict_value, num_pos, num_neg, QUERY_DICT, hard_neg=[], other_neg=False):
	...
	if(len(hard_neg)==0):
		...
		for i in range(num_neg):
			#print("dict_value:", dict_value["negatives"][i])
